...
ax1.set_xlabel('Relative weighted chemistry difference bins')
...
if save_csv:
    ...
    fields = ['dim_weight_chem_diff_bin_min', 'dim_weight_chem_diff_bin_max', 'probability_of_winning', 'probability_of_not_loosing']
    with open('../data/dim_weight_chem_diff_prob.csv', 'w') as f:
        write = csv.writer(f)
