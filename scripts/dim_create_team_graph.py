...
from dim_create_player_graph import get_minutes_played
        ...
        for player_a, player_b in list(combinations(players[team], 2)):
            if player_a != player_b:
                ...
                for result in results:
                    ...
                    original_date = datetime.datetime(int(date.split('-')[0]), int(date.split('-')[1]), int(date.split('-')[2])) 
...
def main():
    ...
    positions = [positions4231, positions433]
